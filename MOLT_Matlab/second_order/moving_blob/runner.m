...
run_type_vanilla_J_rho_BDF1_wave_ng = "BDF1_vanilla_J_rho_FFT_waves_no_gauge_cleaning";
run_type_vanilla_J_rho_BDF2_wave_ng = "BDF2_vanilla_J_rho_FFT_waves_no_gauge_cleaning";
...
for iter = 15:15
    ...
    elseif iter == 16
        run_type = run_type_vanilla_J_rho_BDF1_wave_ng;
    elseif iter == 17
        run_type = run_type_vanilla_J_rho_BDF2_wave_ng;
    elseif iter == 18
    ...
    elseif run_type == run_type_FFT_CDF2_ng
        ...
        gauge_correction = gauge_correction_none;
    elseif run_type == run_type_vanilla_J_rho_BDF1_wave_ng

        update_method_title = "Vanilla Charge Update, BDF-1 Wave Update, FFT Derivative";
        ...
        gauge_correction = gauge_correction_none;
    elseif run_type == run_type_vanilla_J_rho_BDF2_wave_ng

        update_method_title = "Vanilla Charge Update, BDF-2 Wave Update, FFT Derivative";
        update_method_folder = "vanilla_charge_BDF2_wave_update_FFT_derivative";
...
function [] = create_plots_blob(x, y, phi, A1, A2, E1, E2, B3, rho_mesh, J1, J2, gauge_residual, gauss_residual, x1_elec_new, x2_elec_new, t, update_method_title, tag, vidObj)
