...
% Quiet start for v2 using linearly spaced points with a reshuffling
dx_v = (2*v_parallel) / N_p;
v_parallel_velocities = -v_parallel:dx_v:v_parallel-dx_v;
v_parallel_velocities = v_parallel_velocities(randperm(length(v_parallel_velocities)));
...
writematrix(v_parallel_velocities,projectRoot + "\parallel_velocities.csv");
