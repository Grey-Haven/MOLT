...
A1_next_hat = (2*A1_curr_hat - A1_prev_hat + kappa^2*dt^2*A1_src_hat) ./ (1 - kappa^2*dt^2*(-kx'.^2 - ky.^2));
...
A2_next_hat = (2*A2_curr_hat - A2_prev_hat + kappa^2*dt^2*A2_src_hat) ./ (1 - kappa^2*dt^2*(-kx'.^2 - ky.^2));
...
ddx_psi(1:end-1,1:end-1) = real(ifft(sqrt(-1)*kx .*psi_next_fft_x,N_x-1,2));
ddy_psi(1:end-1,1:end-1) = real(ifft(sqrt(-1)*ky'.*psi_next_fft_y,N_y-1,1));
...
ddx_A1(1:end-1,1:end-1) = real(ifft(sqrt(-1)*kx .*A1_next_fft_x,N_x-1,2));
ddy_A1(1:end-1,1:end-1) = real(ifft(sqrt(-1)*ky'.*A1_next_fft_y,N_y-1,1));
...
ddx_A2(1:end-1,1:end-1) = real(ifft(sqrt(-1)*kx .*A2_next_fft_x,N_x-1,2));
ddy_A2(1:end-1,1:end-1) = real(ifft(sqrt(-1)*ky'.*A2_next_fft_y,N_y-1,1));
