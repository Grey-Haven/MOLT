...
if waves_update_method == waves_update_method_BDF1_FD6
...
elseif waves_update_method == waves_update_method_BDF2_FD6
...
psi(1:end-1,1:end-1,end) = solve_helmholtz_MG_FD6(guess, psi_source_with_prev(1:end-1,1:end-1), alpha, dx, dy);

A1(1:end-1,1:end-1,end)  = solve_helmholtz_MG_FD6(guess, A1_source_with_prev(1:end-1,1:end-1) , alpha, dx, dy);

A2(1:end-1,1:end-1,end)  = solve_helmholtz_MG_FD6(guess, A2_source_with_prev(1:end-1,1:end-1) , alpha, dx, dy);
...
[ddx_A1(:,:,end) , ddy_A1(:,:,end) ] = compute_gradient_FD6_per(A1(1:end-1,1:end-1,end) , dx, dy);

[ddx_A2(:,:,end) , ddy_A2(:,:,end) ] = compute_gradient_FD6_per(A2(1:end-1,1:end-1,end) , dx, dy);