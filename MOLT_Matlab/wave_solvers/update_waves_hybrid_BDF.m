...
[psi, ddx_psi, ddy_psi] = BDF_Hybrid_1_4_combined_per_advance(psi, ddx_psi, ddy_psi, psi_src(:,:), ...
...
% A1 uses J1
[A1, ddx_A1, ddy_A1] = BDF_Hybrid_1_4_combined_per_advance(A1, ddx_A1, ddy_A1, A1_src(:,:), ...
                                                           x, y, t_n, dx, dy, dt, kappa, beta_BDF, kx_deriv_1, ky_deriv_1);

% A2 uses J2
[A2, ddx_A2, ddy_A2] = BDF_Hybrid_1_4_combined_per_advance(A2, ddx_A2, ddy_A2, A2_src(:,:), ...
                                                           x, y, t_n, dx, dy, dt, kappa, beta_BDF, kx_deriv_1, ky_deriv_1);