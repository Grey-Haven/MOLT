...
J1_deriv_clean = ifft(sqrt(-1)*kx .*J1_clean_FFTx,N_x-1,2);
J2_deriv_clean = ifft(sqrt(-1)*ky' .*J2_clean_FFTy,N_y-1,1);
...
J1_star_deriv = ifft(sqrt(-1)*kx .*J1_star_FFTx,N_x-1,2);
J2_star_deriv = ifft(sqrt(-1)*ky'.*J2_star_FFTy,N_y-1,1);
